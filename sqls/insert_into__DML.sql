-- INSERT INTO table_name (PK_A, CONTENTS, WRITER)
...
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_02', 'A001', '김영희'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_03', 'A002', '백지영'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_04', 'A002', '최민호'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_05', 'A002', '송지현'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_06', 'A003', '장성우'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_07', 'A004', '백지영'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_08', 'A004', '최민호'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_09', 'A004', '임현서'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
VALUES ('B_10', 'A005', '강수민'); 
INSERT INTO NOTICE_VISITOR (PK_B, FK_A, VISITOR)
